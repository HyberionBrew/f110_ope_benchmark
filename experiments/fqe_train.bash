...
fqe_models=("QFitterDD" "QFitterL2" )


agents=("pure_pursuit2_0.7_0.9_raceline8_0.3_0.5" \ 
...
for lr in "${lrs[@]}"; do
    for tau in "${taus[@]}"; do
        for weight_decay in "${weight_decays[@]}"; do
            for fqe_model in "${fqe_models[@]}"; do
                ...
                for ((i = 0; i < iterations; i++)); do
                    for agent in "${agents[@]}"; do
                        ...
                        python train_fqe.py --train --target_reward=reward_lifetime.json --fqe_model=$fqe_model --eval_interval=1000 --seed=$seed --save_model --update_steps=200_000 --agent=$agent --lr=$lr --tau=$tau --weight_decay=$weight_decay
